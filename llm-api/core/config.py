...
class LLMConfig:
    ...
    def __init__(self):
        ...
        self.cloud_ip: str = os.getenv("LLM_API_CLOUD_IP", "72.19.59.132")  # The public IP of the cloud instance
        self.frontend_port: int = int(os.getenv("LLM_API_FRONTEND_PORT", "47246"))  # 3000 mapped port
        self.api_port: int = int(os.getenv("LLM_API_API_PORT", "47200"))  # 8090 mapped port
