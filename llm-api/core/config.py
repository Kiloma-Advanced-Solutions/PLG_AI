...
class LLMConfig:
    ...
    def __init__(self):
        ...
        self.frontend_port: int = int(os.getenv("LLM_API_FRONTEND_PORT", "10460"))  # 3000 mapped port
        self.api_port: int = int(os.getenv("LLM_API_API_PORT", "10017"))  # 8090 mapped port
