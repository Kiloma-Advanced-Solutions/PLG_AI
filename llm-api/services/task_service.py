...
- זהה למי היא מוקצית. אם לא צוין, השאר כ-null.
...
- assigned_to: האדם האחראי על המשימה או null אם לא ברור
- title: כותרת המשימה
...
- אם המטלה לא ברורה או לא מוקצית לאדם ספציפי - assigned_to יהיה null
