...
class TitleService:
    ...
    def get_title_system_prompt(self) -> str:
        ...
        return """
אתה עוזר מומחה לסיכום הודעות.
המטרה שלך היא ליצור כותרת קצרה המתארת את הודעת המשתמש עד 5 מילים בעברית. על הכותרת להיות תמציתית וברורה ולסכם במדויק את בקשת המשתמש. 
במידה ולא ניתן לזהות מהודעת המשתמש את הכותרת המתארת את מטרת השיחה, החזר ״שיחה חדשה״.
