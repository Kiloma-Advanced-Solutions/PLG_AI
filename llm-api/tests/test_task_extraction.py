...
מדריך ניקוד:
- **90-100**: מעולה - כל המשימות חולצו עם פרטים מושלמים
- **80-89**: טוב מאוד - שגיאות קלות או פרטים אופציונליים חסרים
- **70-79**: טוב - כמה משימות הוחמצו או שגיאות בינוניות
- **60-69**: סביר - מספר שגיאות או משימות חסרות
- **0-59**: חלש - שגיאות גדולות או רוב המשימות הוחמצו
...
אנא ספק:
1. ציון (0-100)
2. הסבר קצר על מה שנעשה טוב
3. מה הוחמץ או לא נכון
4. רשימת המשימות שהיו צריכות להיחלץ
